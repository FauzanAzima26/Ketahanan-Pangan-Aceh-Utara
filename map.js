function renderMap() {
  ...
  // Mapping ID → Nama Kecamatan (sesuai aceh-utara.json)
const kecamatanNames = {
      ...
      regions: [
        {
          attribute: "fill",
          scale: scale,
          values: {}, // diisi setelah ambil region
        },
      ],
    },
    onRegionClick(event, code) {
  const nama = kecamatanNames[code] || code;
  ...
  regionIds.forEach((id, i) => {
    ...
    const nama = kecamatanNames[id] || id; // fallback kalau belum ada mapping
